...
public class SwiftTransactionValidator : AbstractValidator<SwiftTransactionRequest>
{
    public SwiftTransactionValidator()
    {
...
public class SwiftTransactionValidatorForUpdateRequest : AbstractValidator<SwiftTransactionRequestForUpdate>
{
    public SwiftTransactionValidatorForUpdateRequest()
    {
        RuleFor(x => x.ExpensePaymentOrderId)
            .NotEmpty().WithMessage("Expense Payment Order ID cannot be empty");
        RuleFor(x => x.ReferenceNumber)
